...
public class KalmanSeriesProducer extends SplitAdjustedSeriesProducer {
    public KalmanSeriesProducer(StockRepository repository) {
        super(repository);
    }

    public KalmanSeriesProducer(StockRepository repository, LocalDate startDate, LocalDate endDate) {
...
//        limits = new Limits(0, 100000);
    ...
    private InitialProcessEstimate buildInitialProcessEstimate(Double firstValue) {
        ...
        double[][] initialErrorCovariance = new double[][] { { 1, 0 }, { 0, 1 } };
